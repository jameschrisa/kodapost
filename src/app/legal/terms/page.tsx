...
const sections = [
  ...
  { id: "ai-generated-content", title: "Koda-Generated Content" },
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-[1fr_220px] gap-10">
      <article className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <p>
          KodaPost is a Koda-powered carousel creation tool that transforms your
          photos into social media carousels with vintage camera styles, film
          filters, and Koda-generated text overlays. The service includes image
        ...
        <h3>Our Service</h3>
        <p>
          KodaPost, including its design, interface, code, and Koda engine, is
        ...
        <h2 id="ai-generated-content">5. Koda-Generated Content</h2>
        <p>
          Text overlays, captions, and image enhancements generated by Koda
          are created for your use. You own the output and may use it for any
          lawful purpose. However, Koda-generated content may not always be
